...
// Serve other static assets with a fallback
app.get('/assets/*', async (c) => {
  // For now, return a 404 for missing assets
  // In a real deployment, you'd want to serve the actual built assets
...
app.get('*', async (c) => {
  ...
  // Return the built index.html with updated asset paths
...
<html lang="en">
  ...
  <body>
    ...
    <script type="module">
      // Inline the essential app code to avoid asset loading issues
      ...
      const App = () => _jsx("div", {
        ...
        children: [
          _jsx("h1", { children: "TimeOff Manager" }),
          _jsx("p", { children: "Loading application..." }),
          _jsx("p", { children: _jsx("a", { href: "/api/health", children: "Check API Status" }) })
        ]
      });
